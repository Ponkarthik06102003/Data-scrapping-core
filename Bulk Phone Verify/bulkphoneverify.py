...
phnos = open(r'C:\Users\Pon Karthik\PycharmProjects\pythonProject\phone.txt.txt')

line = phnos.readlines()
with open(r'C:\Users\Pon Karthik\PycharmProjects\pythonProject\phone.txt.txt') as fp:
